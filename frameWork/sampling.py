...
s1 = len(X_train_19) + len(X_train_18) + len(X_train_17) + len(X_train_12)
s2 = len(X_test_19) + len(X_test_18) + len(X_test_17) + len(X_test_12)
s3 = len(X_valid_19) +  len(X_valid_18) +  len(X_valid_17) +  len(X_valid_12)
...
# print X_train_21.shape, X_test_21.shape, X_valid_21.shape
...
np.save(path + "X_train_var", X_train)
np.save(path + "T_train_var", T_train)
np.save(path + "C_train_var", C_train)
...
np.save(path + "X_test_var", X_test)
np.save(path + "T_test_var", T_test)
np.save(path + "C_test_var", C_test)
...
np.save(path + "X_valid_var", X_valid)
np.save(path + "T_valid_var", T_valid)
np.save(path + "C_valid_var", C_valid)
